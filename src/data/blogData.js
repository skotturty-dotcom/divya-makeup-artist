...
import img18 from '../assets/media/img18.jpeg';
import img19 from '../assets/media/img19.jpeg';
...
export const blogPosts = [
  {
    id: "top-bridal-makeup-trends-2026",
    title: "Top Bridal Makeup Trends in 2026",
  ...
  },
  {
    ...
    title: "HD vs Airbrush Makeup: Which is Best for Your Big Day?",
    ...
    content: `
      ...
      <ul>
        <li><strong>Choose Airbrush if:</strong> You have oily skin, get married in hot/humid weather, or want maximum sweat-resistance.</li>
        <li><strong>Choose HD if:</strong> You have dry or combination skin and want customizable, dewy, high-coverage glow.</li>
      </ul>
    `
  },
  {
    ...
    content: `
      ...
      <h3>2. Insist on Genuine Luxury Brands</h3>
      <p>Ensure the artist uses authentic luxury cosmetics (Charlotte Tilbury, Dior, NARS, MAC) to prevent allergic reactions or oxidization.</p>

      <h3>3. Schedule a Bridal Consultation or Trial</h3>
      <p>A trial allows you to test foundation shade matching, test longevity on your skin type, and discuss attire co-ordination.</p>
    `
  },
  {
    id: "wedding-makeup-checklist",
    title: "Ultimate Indian Wedding Makeup Checklist for Brides",
    category: "Wedding Preparation",
    readTime: "5 min read",
    date: "July 02, 2026",
    author: "Divya",
    ...
    authorImage: img9,
    image: img17,
    altText: "Indian Wedding Makeup Checklist for Brides",
    metaTitle: "Ultimate Indian Wedding Makeup Checklist for Brides",
    metaDescription: "Never miss a detail! Download the ultimate Indian wedding makeup checklist covering touch-up kits, skin prep, lash glue, and dupatta pins.",
    excerpt: "Everything you need in your emergency touch-up kit—blotting sheets, setting powder, nude lipstick, extra safety pins, and lash adhesive.",
    content: `
      <p>Stay stress-free on your wedding day with our essential bridal makeup bag checklist:</p>

      <ul>
        <li><strong>Emergency Touch-up Powder & Blotting Sheets</strong></li>
        <li><strong>Matching Lip Color & Gloss</strong></li>
        <li><strong>Extra Safety Pins & Hair Bobby Pins</strong></li>
        <li><strong>Hydrating Facial Mist</strong></li>
        <li><strong>Clear Eyelash Glue</strong></li>
      </ul>
    `
  },
  {
    id: "bridal-skincare-routine-before-wedding",
    title: "Bridal Skincare Routine Before Wedding: 6-Month Guide",
    category: "Skin Care",
    readTime: "7 min read",
    date: "June 24, 2026",
    author: "Divya",
    ...
    content: `
      ...
      <h3>6 Months Before: Double Cleansing & Daily SPF 50</h3>
      <p>Establish a consistent skincare routine with gentle double cleansing and hydration serums.</p>

      <h3>3 Months Before: Hydra Facials</h3>
      <p>Schedule monthly Hydra Gold facials to clear congested pores and boost collagen production.</p>

      <h3>1 Month Before: No New Chemical Peels</h3>
      <p>Stick strictly to tested products to avoid sudden breakouts close to your wedding date.</p>
    `
  },
  {
    id: "best-saree-draping-styles",
    title: "Best Saree Draping Styles for Modern & Traditional Brides",
    category: "Beauty Tips",
    readTime: "5 min read",
    date: "June 15, 2026",
    author: "Divya",
  ...
  {
    id: "top-reception-makeup-looks",
    title: "Top Reception Makeup Looks for Evening Glamour",
    category: "Bridal Trends",
    readTime: "4 min read",
    date: "June 05, 2026",
    author: "Divya",
    ...
    content: `
      <p>Wedding receptions call for dramatic evening glamour under grand chandeliers and flash photography. Key elements include bold eye artistry, high-shine collarbone highlights, and long-wear lipstick.</p>
    `
  },
  {
    id: "wedding-makeup-tips-for-indian-brides",
    title: "Wedding Makeup Tips for Indian Brides",
    category: "Beauty Tips",
    readTime: "5 min read",
    date: "May 28, 2026",
    author: "Divya",
    ...
    authorImage: img9,
    image: dm_img10,
    altText: "Wedding Makeup Tips for Indian Brides",
    metaTitle: "Essential Wedding Makeup Tips for Indian Brides",
    metaDescription: "Expert advice on sweat-proofing makeup, lighting considerations, lip shade selection, and trial preparation for Indian brides.",
    excerpt: "Expert advice on sweat-proofing, choosing lip shades that complement jewelry, and maintaining flawless makeup through long rituals.",
    content: `
      <p>Indian weddings feature long rituals, warm sacred fires, and emotional moments. Ensure your makeup stays pristine with waterproof sealants, hydrating primers, and setting sprays.</p>
    `
  }
];
